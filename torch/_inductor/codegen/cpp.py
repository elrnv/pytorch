...
class CppKernel(Kernel):
    ...
    def apply_acc_helper(self, reduction_type, dtype, use_scalar):
        ...
        if reduction_type == "sum" and dtype == torch.float:
            ...
            if hasattr(self, "tiling_idx") and hasattr(self, "tiling_factor"):
                psize = (
                    (
    ...
    def _acc_helper_init(
        ...
        if use_scalar:
            ...
            h_type = self._get_vec_type(dtype) if hasattr(self, "_get_vec_type") else DTYPE_TO_CPP[dtype] 
        helper_init_line = (
            ...
            with contextlib.ExitStack() as stack:
                if tail_loop_kernel.codegen_conditions(
                    ...
                    if type(tail_loop_kernel) == CppKernel:
                        ...
                        # as the reduction vars be extended: tmp_acc -> tmp_acc_arr[].
                        replace_acc_name(tail_loop_kernel.stores, "cascade_sum_combine", "cascade_sum_combine_direct")
                        suffix_buf.splice(
